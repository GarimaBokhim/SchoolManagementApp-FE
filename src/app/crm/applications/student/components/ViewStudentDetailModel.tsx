...
const getEnrolmentTypeText = (type: number) => {
  switch (type) {
    case 1:
      return { label: "Lead", className: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" };
    case 2:
      return { label: "Applicant", className: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400" };
    case 3:
      return { label: "Student", className: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" };
    default:
      return { label: "Unknown", className: "bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400" };
  }
};
...
export const ViewStudentDetailModal = ({
  isOpen,
  onClose,
  studentUserId,
  ...
  useEffect(() => {
    if (!isOpen || !studentUserId) return;
  ...
  const enrolmentType = detail
    ? getEnrolmentTypeText(detail.enrolmentType)
    : null;
          ...
          {detail && !loading && (
            <div>
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-700 dark:text-green-400 font-bold text-lg shrink-0">
              ...
              <DetailRow label="School ID" value={detail.schoolId} />
