        ...
        <div className="relative w-full max-w-6xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl transform transition-all">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Left side - Profile box (now on the left) */}
              <div className="col-span-5">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 sticky top-6">
                  {/* Profile Header */}
