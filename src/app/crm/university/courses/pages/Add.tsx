...
const AddCourseModal: React.FC<AddCourseModalProps> = ({ isOpen, onClose, onSuccess, universities = [] }) => {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-start mb-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                <select name="universityId" value={formData.universityId} onChange={handleChange} required className={inputClass}>
