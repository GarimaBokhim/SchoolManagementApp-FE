...
import { AddInstallmentInvoicePayload } from '../types/IInstallmentInvoice'
import { SubmitHandler, useFieldArray, UseFormReturn } from "react-hook-form";
import { InputElement } from "@/components/Input/InputElement";
import { ButtonElement } from "@/components/Buttons/ButtonElement";
import { Toast } from "@/components/Toast/toast";
import { useAddInstallmentInvoice, useGetAllApplicants } from "../hooks";
import toast from "react-hot-toast";
import useErrorHandler from "@/components/helpers/ErrorHandling";
import { AppCombobox } from "@/components/Input/ComboBox";

type Props = {
    form: UseFormReturn<AddInstallmentInvoicePayload>;
    onClose: () => void;
};
const AddInstallmentInvoiceForm = ({ form, onClose }: Props) => {
    const addInstallmentInvoice = useAddInstallmentInvoice();
    ...
    const onSubmit: SubmitHandler<AddInstallmentInvoicePayload> = async (data) => {
        clearError();
        ...
        await addInstallmentInvoice.mutateAsync(payload);
        handleClose();
        onClose();
    };
    return (
...
export default AddInstallmentInvoiceForm;
