...
import { useUpdateInvoice, useGetAllApplicants } from "../hooks";
import { AppCombobox } from "@/components/Input/ComboBox";



type Props = {
    form: UseFormReturn<UpdateInvoicePayload>
    onClose: () => void;
    InvoiceId: string;
};

const EditInvoiceForm = ({ form, onClose, InvoiceId, }: Props) => {
    const editInvoice = useUpdateInvoice();
    ...
    const onSubmit: SubmitHandler<UpdateInvoicePayload> =
        async (data) => {
            clearError();
            try {
                const promise = editInvoice.mutateAsync({
                    id: InvoiceId,
                    payload: data,
                });
