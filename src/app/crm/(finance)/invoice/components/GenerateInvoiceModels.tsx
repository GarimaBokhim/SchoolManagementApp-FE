...
import { GenerateInvoiceResponse } from '../types/IInvoice';
...
export const GenerateInvoiceModels = ({
    isOpen,
    onClose,
    InvoiceId,
    SchoolId
}: GenerateInvoiceModalProps) => {
    const [detail, setDetail] = useState<GenerateInvoiceResponse | null>(null);
    ...
    useEffect(() => {
        ...
        const fetchDetail = async () => {
            try {
                ...
                const response = await api.get<GenerateInvoiceResponse>(
