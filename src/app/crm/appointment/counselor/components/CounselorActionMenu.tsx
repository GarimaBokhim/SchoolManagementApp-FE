...
interface CounselorActionMenuProps {
  counselor: Counselor;
  onView: (counselor: Counselor) => void;
...
export const CounselorActionMenu = ({
  counselor,
  onView,
  onEdit,
  onDelete,
  ...
  return (
    <div className="flex justify-center">
      ...
      {open && (
        ...
        >
          <button
            onClick={() => { onView(counselor); setOpen(false); }}
