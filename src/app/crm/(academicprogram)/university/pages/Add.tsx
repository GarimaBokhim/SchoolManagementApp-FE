...
const AddUniversity = ({ visible, onClose, CountryId }: Props) => {
    const form = useForm<AddUniversityPayload>({
        defaultValues: {
            name: "",
            countryId: "",
            universityAddress: "",
    ...
    return (
        ...
        >
            ...
            >
                ...
                <AddUniversityForm form={form} onClose={handleOnClose} CountryId={CountryId} />
            </div>
        </div>
    );
};
