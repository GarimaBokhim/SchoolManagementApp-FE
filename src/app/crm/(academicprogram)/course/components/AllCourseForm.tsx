...
import { useDeleteCourse, useGetAllCourse } from '../hooks'
import { CourseResponse } from '../types/ICourse'
import { Tooltip } from '@/components/ToolTip/Tooltip'
import DeleteComponents from '@/components/DeleteComponent/DeleteComponents'
import EditCourse from '../pages/Edit'
import AddCourse from '../pages/Add'
...
const ActionMenu = ({ Course, onEdit, onDelete, canEdit = true, canDelete = true }: ActionMenuProps) => {
        ...
        <div className="flex justify-center">
            ...
            {open && (
                ...
                >
                    ...
                    {canEdit && <button
                        onClick={() => { onEdit(Course); setOpen(false) }}
...
const AllCourseForm = () => {
    ...
    const { data, isLoading, error } = useGetAllCourse(params)
    const deleteCourse = useDeleteCourse()
    const CourseDetails = data?.items ?? [];
    ...
    const handleEditCourse = (FollowUp: CourseResponse) => {
        setEditCourseId(FollowUp.id)
            ...
            <div className="p-4 sm:p-6">
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex w-full justify-between p-3 px-4 pt-4 items-center">
                        <h1 className="text-xl font-semibold dark:text-white">All Course</h1>
                                            ...
                                            <div className="pl-5 pr-4 py-3 space-y-3 text-sm text-gray-600 dark:text-gray-400">
                                                ...
                                                <div className="flex items-start gap-2">
                                                    ...
                                                    <span className="leading-relaxed">
                                                        Tuition Fee: {course.tuationFee || "Not provided"}
                                                    </span>
                                                </div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span>💱</span>
                                                    <span>
                                                        {course.currency || "No currency provided"}
                                                    </span>
                                                </div>
                ...
                {/* Pagination */}
                {CourseDetails.length > 0 && totalPages > 1 && (
                    <div className="mt-4">
                        <Pagination
                            form={paginationForm}
                            pagination={{
