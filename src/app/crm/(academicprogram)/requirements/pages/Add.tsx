...
import AddRequirementsForm from "../components/AddRequirementsForm";
import { RequirementsSchema } from "../valuators/requirements.schema";
...
const AddRequirements = ({ visible, onClose }: Props) => {

    const form = useForm<AddRequirementsPayload>({
        defaultValues: {
            title: "",
            descriptions: "",
            universityId: "",
        ...
        <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center 
            ...
            <div className="bg-[#FBFBFB] dark:bg-[#27272a] 
               ...
               rounded-lg overflow-auto p-6 md:p-8 shadow-lg">
                ...
                <AddRequirementsForm form={form} onClose={handleOnClose} />
            </div>
        </div>
    );
};
