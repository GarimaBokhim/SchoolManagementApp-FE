...
import { useAddDocuments, useGetAllApplicants, useGetAllDocType } from "../hooks";
...
const AddDocumentsForm = ({ form, onClose }: Props) => {
    ...
    const [sellectedDocumentTypeId, setSelectedDocumentTypeId] = useState<string | null>("");
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <AppCombobox
                                                ...
                                                selected={
                                                    documentType?.find(
                                                        (item) =>
                                                            item.id === sellectedDocumentTypeId
                                                    ) || null
                                                }
                                                onSelect={(item) => {
                                                    form.setValue(
