...
import { useDeleteIntake, useGetAllIntake } from '../hooks'
import AddInvoice from '../pages/Add'
import { IntakeResponse } from '../types/IIntake'
import { EditButton } from '@/components/Buttons/EditButton'
import AddIntakees from '../pages/Add'
    ...
    return (
        <div className="flex justify-center">
            ...
            {open && (
                ...
                >
                    <button
                        onClick={() => { onEdit(Intake); setOpen(false) }}
                    ...
                    <button
                        onClick={() => { onDelete(Intake.id); setOpen(false) }}
...
const AllIntakeForm = () => {
    ...
    const handleEditIntake = (Intake: IntakeResponse) => {
        console.log('Edit Intake:', Intake)
    }
            ...
            <div className="p-4 sm:p-6">
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex w-full justify-between p-3 px-4 pt-4 items-center">
                        <h1 className="text-xl font-semibold dark:text-white">All Intake</h1>
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left hidden md:table-cell">IsOpen</th>
                                ...
                                <tbody>
                                    {IntakeeDetails.length === 0 ? (
                                        ...
                                        IntakeeDetails.map((Intakees, index) => (
                                            <tr
                                                key={Intakees.id}
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 text-gray-600 dark:text-gray-300 hidden md:table-cell">
                                                    {Intakees.countryName}
                                                </td>

                                                <td className="px-4 py-3 text-gray-600 dark:text-gray-300 hidden md:table-cell">
                                                    {Intakees.universityName}
                                                </td>
                ...
                {/* Pagination */}
                {IntakeeDetails.length > 0 && totalPages > 1 && (
                    <div className="mt-4">
                        <Pagination
                            form={paginationForm}
                            pagination={{
