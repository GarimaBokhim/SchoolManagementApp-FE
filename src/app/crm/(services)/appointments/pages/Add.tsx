...
import AddAppointmentForm from "../components/AddAppointmentsForm";

interface Props {
    visible: boolean;
    onClose?: () => void;
}
const AddAppointment = ({ visible, onClose }: Props) => {
    const form = useForm<AddAppointmentPayload>({
        defaultValues: {
            leadId: "",
            appointmentDate: "",
            counselorId: "",
    ...
    return (
        ...
        >
            ...
            >
                ...
                <AddAppointmentForm form={form} onClose={handleOnClose} />
            </div>
        </div>
    );
};
