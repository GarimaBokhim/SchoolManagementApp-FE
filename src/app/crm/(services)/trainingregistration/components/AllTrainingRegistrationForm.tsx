...
import { useDeleteTrainingRegistration, useGetAllConsultancyClass, useGetAllTrainingRegistration } from '../hooks'
    ...
    return (
        <>
            ...
            <div className="p-4 sm:p-6">
                                        ...
                                        trainingRegistrationDetails.map((trainingRegistration, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {trainingRegistration.applicantId}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">

                                                    {trainingRegistration.consultancyClassId}
                                                </td>
                ...
                {/* Pagination */}
                {trainingRegistrationDetails.length > 0 && totalPages > 1 && (
                    <div className="mt-4">
                        <Pagination
                            form={paginationForm}
                            pagination={{
