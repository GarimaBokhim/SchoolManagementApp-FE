...
const AllVisaApplicationsForm = () => {
  ...
  // ✅ Main data
  const { data, isLoading, refetch } = useGetAllVisaApplications(params)
  ...
  // ✅ Safe fallback — never early-return on error (same as AllClassesForm)
  ...
  //   const handleAddSubmit = async (payload: AddVisaApplicationPayload) => {
