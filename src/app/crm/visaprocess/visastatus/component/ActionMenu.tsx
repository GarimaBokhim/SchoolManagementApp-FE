...
import { IVisaStatus } from '../types/IVisaStatus';

interface VisaStatusActionMenuProps {
    visaStatus: IVisaStatus;
    onView: (visaStatus: IVisaStatus) => void;
    onEdit: (visaStatus: IVisaStatus) => void;
    onDelete: (id: string) => void;
    canEdit?: boolean;
    canDelete?: boolean;
}

export const VisaStatusActionMenu = ({
    visaStatus,
    onView,
    onEdit,
    onDelete,
    ...
    return (
        <div className="flex justify-center">
            ...
            {open && (
                ...
                >
                    <button
                        onClick={() => { onView(visaStatus); setOpen(false); }}
