...
const AddStudentAward = ({ visible, onClose, form }: props) => {
  ...
  return (
    <>
      ...
      <div className="fixed ml-12 md:ml-64 sm:ml-16 xs:ml-0 inset-0 bg-white bg-opacity-30 z-50 flex items-center justify-center">
        <div className="bg-white dark:bg-[#353535] p-6 rounded-xl w-full max-w-lg shadow-lg relative">
          <button
