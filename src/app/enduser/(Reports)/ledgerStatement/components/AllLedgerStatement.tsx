...
import {
  ILedgers,
  IFilterLedgerByDate,
} from "@/app/enduser/(Accountings)/Ledger/types/ILedgers";
...
import { useFilterLedgersByDate } from "@/app/enduser/(Accountings)/Ledger/hooks";
import { EditButton } from "@/components/Buttons/EditButton";
import LedgerDetails from "./LedgerDetails";

const AllLedgerStatementForm = () => {
      ...
      <div className="p-4 sm:p-6">
        <div className="bg-white dark:bg-[#353535] border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          <div className="flex w-full justify-between p-3 px-4 pt-4 items-center ">
            <h1 className=" text-xl font-semibold ">All Ledger Statement</h1>
            ...
            <table className="w-full border-collapse text-xs sm:text-sm">
              <thead>
                <tr className="bg-gray-50 dark:text-white text-gray-700 dark:bg-[#80878c] uppercase text-sm font-semibold border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 text-center w-[180px]">Details</th>
                </tr>
              </thead>
...
export default AllLedgerStatementForm;
