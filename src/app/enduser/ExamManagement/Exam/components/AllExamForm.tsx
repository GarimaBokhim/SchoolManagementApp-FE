...
const AllExamForm = ({ onDataFromChild }: Props) => {
              ...
              <table className="w-full border-collapse text-xs sm:text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:text-white text-gray-700 dark:bg-[#80878c] uppercase text-sm font-semibold border-b border-gray-200">
                    ...
                    <th className="px-4 py-3 text-left">Total Mark</th>
                    <th className="px-4 py-3 text-left">Passing Mark</th>
                    <th className="px-4 py-3 text-left">Is Final Exam</th>
                  ...
                  {isLoading ? (
                    ...
                    filteredExam?.Items.map((Exam: IExam, index: number) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">{Exam.passingMarks}</td>
