...
const AllStudent = () => {
  ...
  return (
    <div className="p-4 h-full ">
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-b-lg h-[90%] px-2 p-6 bg-white dark:bg-gray-800 transition-all overflow-auto cursor-pointer">
        {renderStudent()}
      </div>
    </div>
  )
