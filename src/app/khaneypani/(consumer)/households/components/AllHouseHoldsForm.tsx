...
import AddHouseHoldses from '../pages/Add'
                ...
                >
                    ...
                    {/* {canEdit && (
                        <button
                            ...
                            HouseHoldsName="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
                        >
                            <Edit size={14} /> Edit
                        </button>
                    )} */}
                    ...
                    {/* {canDelete && (
                        <button
                            ...
                            HouseHoldsName="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
                        >
                            <Trash size={14} /> Delete
                        </button>
                    )} */}
...
const AllHouseHoldsForm = () => {
    ...
    const [selectedConsumerName, setSelectedConsumerName] = useState<string | null>(
        ""
    );
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-[240px]">
                                    <AppCombobox
                                        ...
                                        selected={
                                            data?.Items?.find(
                                                (g) => g.consumerName === selectedConsumerName
                                            ) || null
                                        }
                                        onSelect={(group) => {
                                            if (group) {
                                                setSelectedConsumerName(group.consumerName || null);
                                            } else {
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left hidden md:table-cell">Wardnumber</th>
                                        <th className="px-4 py-3 text-left hidden md:table-cell">Tole</th>
                                        <th className="px-4 py-3 text-left hidden md:table-cell">RegistrationDate</th>
                                        <th className="px-4 py-3 text-center">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {HouseHoldseDetails.length === 0 ? (
                                        <tr>
                                            <td
                                                colSpan={8}
                                        ...
                                        HouseHoldseDetails.map((HouseHoldses, index) => (
                                            <tr
                                                key={HouseHoldses.id}
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {HouseHoldses.consumerName}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {HouseHoldses.meterNumber}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">

                                                    {HouseHoldses.contactNumber}
                                                </td>
                                                <td className="px-4 py-3 text-gray-600 dark:text-gray-300 hidden md:table-cell">
                                                    {HouseHoldses.wardnumber}
                                                </td>
