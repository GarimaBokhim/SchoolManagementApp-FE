...
import AddStaffes from '../pages/Add'
    ...
    return (
        <div className="flex justify-center">
            ...
            {open && (
                ...
                >
                    <button
                        onClick={() => { onEdit(Staff); setOpen(false) }}
                    ...
                    <button
                        onClick={() => { onDelete(Staff.id); setOpen(false) }}
                    ...
                    {/* {canEdit && (
                        <button
                            ...
                            StaffName="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
                        >
                            <Edit size={14} /> Edit
                        </button>
                    )} */}
                    ...
                    {/* {canDelete && (
                        <button
                            ...
                            StaffName="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
                        >
                            <Trash size={14} /> Delete
                        </button>
                    )} */}
...
const AllStaffForm = () => {
    ...
    const [selectedFullName, setSelectedFullName] = useState<string | null>(
        ""
    );
            ...
            <div className="p-4 sm:p-6">
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex w-full justify-between p-3 px-4 pt-4 items-center">
                        <h1 className="text-xl font-semibold dark:text-white">All Staff</h1>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-[240px]">
                                    <AppCombobox
                                        ...
                                        onSelect={(group) => {
                                            if (group) {
                                                setSelectedFullName(group.fullName || null);
                                            } else {
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left">EmployeeCode</th>
                                        <th className="px-4 py-3 text-left">FullName</th>
                                        <th className="px-4 py-3 text-left hidden md:table-cell">Email</th>
                                        <th className="px-4 py-3 text-left hidden md:table-cell">Password</th>
                                ...
                                <tbody>
                                    {StaffeDetails.length === 0 ? (
                                        ...
                                        StaffeDetails.map((Staffes, index) => (
                                            <tr
                                                key={Staffes.id}
