    ...
    return (
        <div className="flex justify-center">
            ...
            {open && (
                ...
                >
                    <button
                        onClick={() => { onEdit(WaterBillingRuleSlab); setOpen(false) }}
                    ...
                    <button
                        onClick={() => { onDelete(WaterBillingRuleSlab.id); setOpen(false) }}
...
const AllWaterBillingRuleSlabForm = () => {
    ...
    const [selectedWaterBillingRuleSlabName, setSelectedWaterBillingRuleSlabName] = useState<string | null>(
        ""
    );
    ...
    const { data, isLoading, error } = useGetAllWaterBillingRuleSlab(fullQuery)
    const deleteWaterBillingRuleSlab = useDeleteWaterBillingRuleSlab()


    const WaterBillingRuleSlabDetails = data?.Items ?? [];
    ...
    const WaterBillingRuleSlabType = [
    ...
    const handleDelete = async (id: string) => {
        try {
            console.error("Id", id)
            await deleteWaterBillingRuleSlab.mutateAsync(id)
        } catch (error) {
            console.error(error)
        }
    }
                ...
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-8">
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">
                            Error loading WaterBillingRuleSlab Status
                        </h3>
            ...
            <div className="p-4 sm:p-6">
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex w-full justify-between p-3 px-4 pt-4 items-center">
                        <h1 className="text-xl font-semibold dark:text-white">All WaterBillingRuleSlab</h1>
                        ...
                        <div className="mb-6 mx-4 bg-white dark:bg-[#353535] p-5 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                            ...
                            >
                                ...
                                {/* <div className="flex-1 min-w-[240px]">
                                    <AppCombobox
                                        value={selectedWaterBillingRuleSlabName}
                                        dropDownWidth="w-full"
                                        dropdownPositionClass="absolute"
                                        label="WaterBillingRuleSlab Name"
                                        name="fullName"
                                        form={form}
                                        options={data?.Items}
                                        selected={
                                            data?.Items?.find(
                                                (g) => g.fullName === selectedWaterBillingRuleSlabName
                                            ) || null
                                        }
                                        onSelect={(group) => {
                                            if (group) {
                                                setSelectedWaterBillingRuleSlabName(group.fullName || null);
                                            } else {
                                                setSelectedWaterBillingRuleSlabName(null);
                                            }
                                        }}
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left">billingRule</th>
                                        <th className="px-4 py-3 text-left">FromUnit</th>
                                        <th className="px-4 py-3 text-left">ToUnit</th>
                                        <th className="px-4 py-3 text-left">RatePerUnit</th>
                                        <th className="px-4 py-3 text-center">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {WaterBillingRuleSlabDetails.length === 0 ? (
                                        <tr>
                                            <td colSpan={9} className="p-4 text-center italic text-gray-500 dark:text-gray-400">
                                                No WaterBillingRuleSlab found.
                                            </td>
                                        </tr>
                                    ) : (
                                        WaterBillingRuleSlabDetails.map((WaterBillingRuleSlab, index) => (
                                            <tr
                                                key={WaterBillingRuleSlab.id}
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {WaterBillingRuleSlab.toUnit}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {WaterBillingRuleSlab.ratePerUnit}
                                                </td>
...
export default AllWaterBillingRuleSlabForm