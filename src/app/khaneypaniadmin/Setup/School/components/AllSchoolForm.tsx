...
import { useRemoveSchool, useGetAllSchool } from "../hooks";
                                ...
                                {allSchool && allSchool?.Items?.length > 0 ? (
                                    allSchool?.Items.map((School: ISchool, index: number) => (
                                        ...
                                        >
                                            ...
                                            {/* <td className="py-3 px-4">{School.classs}</td> */}
                                            ...
                                            <td className="">
                                                <div className="flex flex-wrap items-start ">
                                                    {School.Users.map((item) => (
                                                        <div key={item.userId} className="pl-1 ">
                ...
                {allSchool && allSchool?.Items?.length > 0 && (
                    <Pagination
                        ...
                        pagination={{
                            ...
                            firstPage: Array.isArray(allSchool)
                                ? 1
                                : allSchool?.FirstPage ?? 1,
