...
const AllStaffForm = () => {
    ...
    const { data, isLoading, error } = useGetAllStaff(fullQuery)
    const deleteStaff = useDeleteStaff()


    const StaffDetails = data?.Items ?? [];
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-[240px]">
                                    <AppCombobox
                                        ...
                                        selected={
                                            data?.Items?.find(
                                                (g) => g.fullName === selectedStaffName
                                            ) || null
                                        }
                                        onSelect={(group) => {
                                            if (group) {
                                                setSelectedStaffName(group.fullName || null);
                                            } else {
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left">JoiningDate</th>
