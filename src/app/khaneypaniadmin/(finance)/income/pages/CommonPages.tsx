...
import AllWaterIncome from './All'
const AllWaterIncomeDetails = () => {
    const tabs = [
        { id: 'WaterIncome', label: 'WaterIncome' },
        // { id: 'WaterBillingRule', label: 'WaterBillingRule' },
        // { id: 'WaterBillingRuleSlab', label: 'WaterBillingRuleSlab' },
    ]

    const [activeTab, setActiveTab] = useState<string>('WaterIncome')

    const renderContent = () => {
        switch (activeTab) {
            case 'WaterIncome':
                return <AllWaterIncome />
...
export default AllWaterIncomeDetails
