...
import AllWaterPayments from './All'
const AllWaterPaymentsDetails = () => {
    const tabs = [
        { id: 'WaterPayments', label: 'WaterPayments' },
        // { id: 'WaterBillingRule', label: 'WaterBillingRule' },
        // { id: 'WaterBillingRuleSlab', label: 'WaterBillingRuleSlab' },
    ]

    const [activeTab, setActiveTab] = useState<string>('WaterPayments')

    const renderContent = () => {
        switch (activeTab) {
            case 'WaterPayments':
                return <AllWaterPayments />
...
export default AllWaterPaymentsDetails
