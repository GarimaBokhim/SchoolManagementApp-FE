...
import { ArrowUpRight, BookOpen, Edit, Filter, MoreVertical, Plus, ReceiptIndianRupeeIcon, RotateCcw, Trash } from 'lucide-react'
...
import { useGetAllHouseHolds } from '../hooks'
import ConsumerStatementModal from './ConsumerStatementModal'
...
const AllHouseHoldsForm = () => {
    ...
    const [statementModalOpen, setStatementModalOpen] =
        useState(false)
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3">
                                                    <button
                                                        type="button"
                                                        onClick={() =>
                                                            handleConsumerClick(HouseHolds.id)
                                                        }
                                                    ...
                                                    >
                                                        <span>{HouseHolds.consumerName}</span>
