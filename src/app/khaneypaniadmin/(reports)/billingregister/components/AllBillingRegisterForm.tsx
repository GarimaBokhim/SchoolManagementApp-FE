...
import { useGetAllBillingRegister } from '../hooks'
...
const AllBillingRegisterForm = () => {
    ...
    const [selectedBillingRegisterName, setSelectedBillingRegisterName] = useState<string | null>(
        ""
    );
    ...
    const { data, isLoading, error } = useGetAllBillingRegister(fullQuery)


    const BillingRegisterDetails = data?.Items ?? [];
            ...
            <div className="p-4 sm:p-6">
                <div className="bg-white dark:bg-[#353535] border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex w-full justify-between p-3 px-4 pt-4 items-center">
                        <h1 className="text-xl font-semibold dark:text-white">All BillingRegister</h1>
                        ...
                        <div className="mb-6 mx-4 bg-white dark:bg-[#353535] p-5 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-[240px]">
                                    <AppCombobox
                                        value={selectedBillingRegisterName}
                                        ...
                                        selected={
                                            data?.Items?.find(
                                                (g) => g.consumerName === selectedBillingRegisterName
                                            ) || null
                                        }
                                        onSelect={(group) => {
                                            if (group) {
                                                setSelectedBillingRegisterName(group.consumerName || null);
                                            } else {
                                                setSelectedBillingRegisterName(null);
                                            }
                                        }}
                            ...
                            <table className="min-w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-[#80878c] uppercase font-semibold border-b">
                                        ...
                                        <th className="px-4 py-3 text-left">BillNumber</th>
                                        ...
                                        <th className="px-4 py-3 text-left">TotalAmount</th>
                                        <th className="px-4 py-3 text-left">PaidAmount</th>
                                        <th className="px-4 py-3 text-left">OutstandingAmount</th>
                                ...
                                <tbody>
                                    {BillingRegisterDetails.length === 0 ? (
                                        <tr>
                                            <td colSpan={9} className="p-4 text-center italic text-gray-500 dark:text-gray-400">
                                                No visa BillingRegister found.
                                            </td>
                                        </tr>
                                    ) : (
                                        BillingRegisterDetails.map((BillingRegister, index) => (
                                            <tr
                                                key={BillingRegister.billingId}
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.billNumber}
                                                </td>
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.billDate}
                                                </td>
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.consumerName}
                                                </td>
                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.meterNumber}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.consumption}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.totalAmount}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.paidAmount}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.outstandingAmount}
                                                </td>

                                                <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                                    {BillingRegister.billStatus === 1 && "Draft"}
                                                </td>
...
export default AllBillingRegisterForm