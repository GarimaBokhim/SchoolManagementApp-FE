...
import AllDueReports from './All'
const AllDueReportsDetails = () => {
    const tabs = [
        { id: 'DueReports', label: 'DueReports' },
    ]

    const [activeTab, setActiveTab] = useState<string>('DueReports')
...
export default AllDueReportsDetails
