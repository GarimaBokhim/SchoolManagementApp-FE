          ...
          <div className="relative mt-1">
            <div className="relative items-center flex">
              <ComboboxInput
                ...
                className={`w-64 p-2  py-1.5 border  rounded-md outline-none peer placeholder:opacity-0 bg-[#ffffff] focus:border-[#4788CD] border-gray-400 dark:bg-[#353535] dark:text-white  ${
