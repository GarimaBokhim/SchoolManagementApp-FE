...
const RichTextEditor = ({ editor }: { editor: Editor | null }) => {
  ...
  const editorClasses = 'bg-white border-gray-300 text-gray-900'
...
<Tooltip content="Go to previous cell">
  ...
  <div className={`flex items-center space-x-1 p-1 rounded shadow-lg ${'bg-white'}`}>
    <button
      type="button"
      onClick={() => editor.chain().focus().toggleBold().run()}
      className={`p-1 rounded ${buttonClasses} ${editor.isActive('bold') ? ('bg-blue-500') : ''}`}
    >
      <Bold className="w-4 h-4" />
    </button>
    ...
    <button
      type="button"
      onClick={() => editor.chain().focus().toggleItalic().run()}
      className={`p-1 ${buttonClasses} rounded ${editor.isActive('italic') ? ('bg-blue-500') : ''}`}
    >
      <Italic className="w-4 h-4" />
    </button>
    ...
    <button
      type="button"
      onClick={() => editor.chain().focus().toggleUnderline().run()}
      className={`p-1 rounded ${buttonClasses} ${editor.isActive('underline') ? ( 'bg-blue-500') : ''}`}
    >
      <UnderlineIcon className="w-4 h-4" />
    </button>
    ...
    <button
      type="button"
      onClick={setLink}
      className={`p-1 rounded ${buttonClasses} ${editor.isActive('link') ? ( 'bg-blue-500') : ''}`}
    >
      <LinkIcon className="w-4 h-4" />
    </button>
  </div>
